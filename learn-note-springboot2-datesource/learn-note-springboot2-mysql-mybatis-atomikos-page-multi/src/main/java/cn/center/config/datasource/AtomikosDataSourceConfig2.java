...
@MapperScan(basePackages = "cn.center.mapper.datasource2", sqlSessionTemplateRef = "app2SqlSessionTemplate")
public class AtomikosDataSourceConfig2 {

	@Bean(name = "app2DataSource")
	public DataSource app2DataSource(DBConfig2 ds) throws SQLException {
		...
		xaDataSource.setUniqueResourceName("app2DataSource");
		return xaDataSource;
	}

	@Bean(name = "app2SqlSessionFactory")
	public SqlSessionFactory app2SqlSessionFactory(@Qualifier("app2DataSource") DataSource datasource) throws Exception {
...
//      特别注意：使用 SqlServer2012 数据库时，需要手动指定为 sqlserver2012，否则会使用 SqlServer2005 的方式进行分页。
		...
		bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:cn.center.mapper.datasource2/*.xml"));
		return bean.getObject();
	}

	@Bean("app2SqlSessionTemplate")
	public SqlSessionTemplate app2sqlsessiontemplate(@Qualifier("app2SqlSessionFactory") SqlSessionFactory sessionfactory) {

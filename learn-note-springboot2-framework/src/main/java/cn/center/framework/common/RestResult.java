...
public class RestResult<T> extends HashMap<String, Object> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("code", getCode()).append("msg", getMsg()).append("data", getData()).toString();
	}
	
	public static void main(String[] args) {
		HashMap<String, Object> ret = RestResult.success();
		System.out.println(ret.get("msg"));
		System.out.println(RestResult.Type.WARN.value);
	}
}
